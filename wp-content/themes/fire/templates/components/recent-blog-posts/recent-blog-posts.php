      ...
      ?>
        <div class="w-full px-3 mb-12 lg:w-1/3">
          <a class="no-underline" href="<?php the_permalink();?>">
            <img
                class="object-cover w-full rounded h-80"
            ...
            <p class="text-lg leading-loose text-gray-600 line-clamp-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed luctus eget justo et iaculis.</p>
          </a>
        </div>
      <?php endwhile;
      wp_reset_query();
