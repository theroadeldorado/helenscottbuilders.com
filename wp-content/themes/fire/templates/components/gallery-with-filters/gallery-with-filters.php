...
<?php $section->start(); ?>
  ...
  <div class="px-4" x-data="galleryDisplay" x-ref="gallerySection">
    ...
    <p x-cloak class="py-4 italic text-center" x-text="currentTerm === 'all-homes' ? 'Click an image below to view each home\'s full image gallery.' : 'Click on images to view larger versions.'"></p>
